...
class RiskEngine:
    ...
    def check_constraints(
        ...
        current_leverage = total_notional / total_equity if total_equity > 0 else 0.0
        action_notional = abs(proposed_action.get("size", 0) * proposed_action.get("price", 0))
        projected_leverage = (total_notional + action_notional) / total_equity if total_equity > 0 else 0.0
